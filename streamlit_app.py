...
- Has obtained professional certifications from Data Scientist, Data Analyst and a Python Developer certificate, and SQL Fundamental on the DataCamp platform.
''')
